...
func NewTaskServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TaskServiceClient {
	...
	taskServiceMethods := v1.File_tasks_v1_tasks_proto.Services().ByName("TaskService").Methods()
	return &taskServiceClient{
		executeTask: connect.NewClient[v1.SubmitTaskRequest, v1.SubmitTaskResponse](
			httpClient,
			baseURL+TaskServiceExecuteTaskProcedure,
...
func (c *taskServiceClient) ExecuteTask(ctx context.Context, req *connect.Request[v1.SubmitTaskRequest]) (*connect.Response[v1.SubmitTaskResponse], error) {
...
func NewTaskServiceHandler(svc TaskServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	taskServiceMethods := v1.File_tasks_v1_tasks_proto.Services().ByName("TaskService").Methods()
	taskServiceExecuteTaskHandler := connect.NewUnaryHandler(
		TaskServiceExecuteTaskProcedure,
		svc.ExecuteTask,
		connect.WithSchema(taskServiceMethods.ByName("ExecuteTask")),
